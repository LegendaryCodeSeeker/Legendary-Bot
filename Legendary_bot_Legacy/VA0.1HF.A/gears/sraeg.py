...
class general_cmds():
    ...
    async def helpcmd(self, ctx):
        ...
        embed.set_footer(text="Legendary Bot V0.1 Alpha")
        embed.add_field(name="General Commands", value="/test - Tests the bot to make sure it's working\n/help - Gives commands in DM\n/about - Tells you about the bot\n/dict <word> - Gives you a definition of a word.")
        embed.add_field(name="Music commands", value="/play <URL> - Plays a YouTube or Soundcloud URL\n/stop - Stops playing.")
        embed.add_field(name="Administration commands", value="/delete <amt> - Deletes a certain amount of messages\n/kick <@user> - Kicks a certain user\n/ban <@user> - Bans a certain user")
